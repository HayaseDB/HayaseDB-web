<template>
  ...
  >
    ...
    >
      <p class="text-sm text-gray-700 md:pr-4">
        ...
        <a href="/privacy-policy" class="text-blue-600 hover:underline font-medium">
          Privacy Policy
        </a>
        and
        <a href="/cookie-policy" class="text-blue-600 hover:underline font-medium">
          Cookie Policy
        </a>.
      </p>
      <button
  ...
  <div class="fixed left-5 bottom-0 w-40 h-40 pointer-events-none overflow-hidden">
    <img
        v-if="showMascot"
